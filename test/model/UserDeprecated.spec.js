...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.UserDeprecated();
  });
  ...
  describe('UserDeprecated', function() {
    it('should create an instance of UserDeprecated', function() {
      // uncomment below and update the code to test UserDeprecated
      //var instance = new BlueJeansMeetingsRestApi.UserDeprecated();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.UserDeprecated);
    });
