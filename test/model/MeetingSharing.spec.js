...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.MeetingSharing();
  });
  ...
  describe('MeetingSharing', function() {
    it('should create an instance of MeetingSharing', function() {
      // uncomment below and update the code to test MeetingSharing
      //var instance = new BlueJeansMeetingsRestApi.MeetingSharing();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.MeetingSharing);
    });
