...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.RecordingSummary();
  });
  ...
  describe('RecordingSummary', function() {
    it('should create an instance of RecordingSummary', function() {
      ...
      //var instance = new BlueJeansMeetingsRestApi.RecordingSummary();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.RecordingSummary);
    });
