...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptionsEditability();
  });
  ...
  describe('MeetingAdvancedMeetingOptionsEditability', function() {
    it('should create an instance of MeetingAdvancedMeetingOptionsEditability', function() {
      // uncomment below and update the code to test MeetingAdvancedMeetingOptionsEditability
      //var instance = new BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptionsEditability();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptionsEditability);
    });
