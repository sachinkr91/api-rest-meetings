...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.PersonalMeetingRoomAdvancedMeetingOptions();
  });
  ...
  describe('PersonalMeetingRoomAdvancedMeetingOptions', function() {
    it('should create an instance of PersonalMeetingRoomAdvancedMeetingOptions', function() {
      // uncomment below and update the code to test PersonalMeetingRoomAdvancedMeetingOptions
      //var instance = new BlueJeansMeetingsRestApi.PersonalMeetingRoomAdvancedMeetingOptions();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.PersonalMeetingRoomAdvancedMeetingOptions);
    });
    ...
    it('should have the property allowStream (base name: "allowStream")', function() {
      // uncomment below and update the code to test the property allowStream
      //var instance = new BlueJeansMeetingsRestApi.PersonalMeetingRoomAdvancedMeetingOptions();
      //expect(instance).to.be();
    });
