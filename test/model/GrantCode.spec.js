...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.GrantCode();
  });
  ...
  describe('GrantCode', function() {
    it('should create an instance of GrantCode', function() {
      // uncomment below and update the code to test GrantCode
      //var instance = new BlueJeansMeetingsRestApi.GrantCode();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.GrantCode);
    });
