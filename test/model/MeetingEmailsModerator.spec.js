...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.MeetingEmailsModerator();
  });
  ...
  describe('MeetingEmailsModerator', function() {
    it('should create an instance of MeetingEmailsModerator', function() {
      // uncomment below and update the code to test MeetingEmailsModerator
      //var instance = new BlueJeansMeetingsRestApi.MeetingEmailsModerator();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.MeetingEmailsModerator);
    });
