...
from BlueJeansMeetingsRestApi.apis.recording_api import RecordingApi
...
class TestRecordingApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = BlueJeansMeetingsRestApi.apis.recording_api.RecordingApi()
    ...
    def test_v1_user_user_id_meeting_history_meeting_id_recordings_recording_chapter_id_delete(self):
        """
        Test case for v1_user_user_id_meeting_history_meeting_id_recordings_recording_chapter_id_delete
