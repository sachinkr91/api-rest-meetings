...
class MeetingHistory implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['meeting_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'meeting_status', must be one of 'Complete'.";
        }

        $allowed_values = ["PROCESSED"];
        if (!in_array($this->container['processing_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'processing_status', must be one of 'PROCESSED'.";
        }
