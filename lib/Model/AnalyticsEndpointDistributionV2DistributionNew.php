...
/**
 * AnalyticsEndpointDistributionV2DistributionNew Class Doc Comment
 *
 * @category Class
 * @package  BlueJeansMeetingsRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnalyticsEndpointDistributionV2DistributionNew implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnalyticsEndpointDistributionV2_distribution_new';
     ...
     * Sets endpoint_type
     *
     * @param string $endpoint_type Name of endpoint device type
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Count of the number of device engagements
     *
     * @return $this
     */
