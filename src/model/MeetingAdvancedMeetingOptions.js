...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MeetingAdvancedMeetingOptionsEditability'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MeetingAdvancedMeetingOptionsEditability'));
  } else {
    // Browser globals (root is window)
    if (!root.BlueJeansMeetingsRestApi) {
      root.BlueJeansMeetingsRestApi = {};
    }
    root.BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptions = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptionsEditability);
  }
}(this, function(ApiClient, MeetingAdvancedMeetingOptionsEditability) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('editability')) {
        obj['editability'] = MeetingAdvancedMeetingOptionsEditability.constructFromObject(data['editability']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/MeetingAdvancedMeetingOptionsEditability} editability
   */
