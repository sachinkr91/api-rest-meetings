...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.PayloadPairingCodeWebRTC = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The PayloadPairingCodeWebRTC model module.
   * @module model/PayloadPairingCodeWebRTC
   * @version 1.0.4407232018
   */

  /**
   * Constructs a new <code>PayloadPairingCodeWebRTC</code>.
   * @alias module:model/PayloadPairingCodeWebRTC
   * @class
   */
  ...
  /**
   * Constructs a <code>PayloadPairingCodeWebRTC</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PayloadPairingCodeWebRTC} obj Optional instance to populate.
   * @return {module:model/PayloadPairingCodeWebRTC} The populated <code>PayloadPairingCodeWebRTC</code> instance.
   */
   ...
   * @member {module:model/PayloadPairingCodeWebRTC.EndpointTypeEnum} endpointType
   */
  ...
  /**
   * @member {module:model/PayloadPairingCodeWebRTC.LanguageCodeEnum} languageCode
   */
   ...
   * @member {Array.<module:model/PayloadPairingCodeWebRTC.CapabilitiesEnum>} capabilities
   */
