...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantRequestMeeting = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
   ...
   * @class
   * @param grantType {module:model/GrantRequestMeeting.GrantTypeEnum} The type of access token you are requesting.
   ...
   * @member {module:model/GrantRequestMeeting.GrantTypeEnum} grant_type
