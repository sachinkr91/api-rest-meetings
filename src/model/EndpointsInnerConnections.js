...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.EndpointsInnerConnections = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The EndpointsInnerConnections model module.
   * @module model/EndpointsInnerConnections
   * @version 1.0.4407232018
   */

  /**
   * Constructs a new <code>EndpointsInnerConnections</code>.
   * @alias module:model/EndpointsInnerConnections
   * @class
   */
  ...
  /**
   * Constructs a <code>EndpointsInnerConnections</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EndpointsInnerConnections} obj Optional instance to populate.
   * @return {module:model/EndpointsInnerConnections} The populated <code>EndpointsInnerConnections</code> instance.
   */
