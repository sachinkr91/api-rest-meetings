...
# **createUser**
> \BlueJeansMeetingsRestApi\Model\UserId createUser($enterprise_id, $user, $force_password_change, $send_verification_mail)
...
$user = new \BlueJeansMeetingsRestApi\Model\User(); // \BlueJeansMeetingsRestApi\Model\User | The information about the new user.
 ...
 **user** | [**\BlueJeansMeetingsRestApi\Model\User**](../Model/User.md)| The information about the new user. |
...
# **listUsers**
> \BlueJeansMeetingsRestApi\Model\EnterpriseUserList listUsers($enterprise_id, $page_size, $page_number, $email_id)
...
[**\BlueJeansMeetingsRestApi\Model\EnterpriseUserList**](../Model/EnterpriseUserList.md)
