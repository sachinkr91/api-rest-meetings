 ...
 **application** | [**\BlueJeansOnVideoRestApi\Model\Application**](../Model/\BlueJeansOnVideoRestApi\Model\Application.md)| The information about the new client application. |
