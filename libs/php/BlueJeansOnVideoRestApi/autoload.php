 ...
 * would cause the function to attempt to load the \BlueJeansOnVideoRestApi\Baz\Qux class
 * from /path/to/project/lib/Baz/Qux.php:
 *
 *      new \BlueJeansOnVideoRestApi\Baz\Qux;
 *
...
spl_autoload_register(function ($class) {
    ...
    $prefix = 'BlueJeansOnVideoRestApi\\';
