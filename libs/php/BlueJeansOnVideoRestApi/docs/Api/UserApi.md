...
------------- | ------------- | ------------- | -------------
 **user_id** | **int**| The ID of the user of interest. This value is an integer which can be retrieved for the current user via the Get User Account Details endpoint. |
 **room** | [**\BlueJeansOnVideoRestApi\Model\Room**](../Model/Room.md)| The user&#39;s room details that you wish to update. |
...
------------- | ------------- | ------------- | -------------
 **user_id** | **int**| The ID of the user of interest. This value is an integer which can be retrieved for the current user via the Get User Account Details endpoint. |
 **user** | [**\BlueJeansOnVideoRestApi\Model\User**](../Model/User.md)| The user details that you wish to update. |
