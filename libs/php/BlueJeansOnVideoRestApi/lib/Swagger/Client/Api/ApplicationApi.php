...
class ApplicationApi
{
    ...
    public function createClientApplicationWithHttpInfo($user_id, $application)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Application', $httpHeader), $statusCode, $httpHeader);
    ...
    public function regenerateClientApplicationSecretWithHttpInfo($user_id, $client_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ApplicationSecret', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
