...
class MeetingState implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'recordinginfo' => '\Swagger\Client\Model\MeetingStateRecordinginfo'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("MeetingStarted");
        if (!in_array($this->container['meeting_state'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'meeting_state', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('MeetingStarted');
        if (!in_array($meeting_state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'meeting_state', must be one of 'MeetingStarted'");
        }
    ...
    /**
     * Gets recordinginfo
     * @return \Swagger\Client\Model\MeetingStateRecordinginfo
     */
    ...
    /**
     * Sets recordinginfo
     * @param \Swagger\Client\Model\MeetingStateRecordinginfo $recordinginfo
     * @return $this
     */
