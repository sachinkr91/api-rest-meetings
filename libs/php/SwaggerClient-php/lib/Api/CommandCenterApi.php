...
class CommandCenterApi
{
    ...
    public function getEndpointDistributionWithHttpInfo($enterprise_id, $filter = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsEndpointDistribution', $httpHeader), $statusCode, $httpHeader];
    ...
    public function getFeedbackCommentsWithHttpInfo($enterprise_id, $start, $end)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsFeedbackComments', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getFeedbackCountWithHttpInfo($enterprise_id, $start, $end)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsFeedbackScores', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getMeetingUsageWithHttpInfo($enterprise_id, $client_tz = null, $filter = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsUsage', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getRoiRangesWithHttpInfo($enterprise_id, $filter)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsRoiData', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getTopUsersWithHttpInfo($enterprise_id, $filter = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\AnalyticsTopUsers', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
