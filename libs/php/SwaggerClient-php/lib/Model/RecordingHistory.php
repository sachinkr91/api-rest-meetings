...
class RecordingHistory implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['composite_content_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'composite_content_status', must be one of 'PROCESSED'.";
        }
    ...
    public function setCompositeContentStatus($composite_content_status)
    {
        ...
        if (!is_null($composite_content_status) && (!in_array($composite_content_status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'composite_content_status', must be one of 'PROCESSED'");
        }
