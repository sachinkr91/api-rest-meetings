...
- API version: 1.0.0
- Build date: 2017-02-21T16:00:35.275-07:00
...
*MeetingApi* | [**v1UserUserIdLiveMeetingsMeetingIdPairingCodeWebrtcPost**](docs/Api/MeetingApi.md#v1useruseridlivemeetingsmeetingidpairingcodewebrtcpost) | **POST** /v1/user/{user_id}/live_meetings/{meeting_id}/pairing_code/webrtc | Generate SIP Pairing Code
