...
> \Swagger\Client\Model\Meeting v1UserUserIdCmsContentIdisDownloadabletrueGet($user_id, $content_id)
...
try {
    ...
    echo 'Exception when calling RecordingApi->v1UserUserIdCmsContentIdisDownloadabletrueGet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\Meeting v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstartPost($user_id, $meeting_id)
...
try {
    $result = $api_instance->v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstartPost($user_id, $meeting_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling RecordingApi->v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstartPost: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Swagger\Client\Model\Meeting v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstopPut($user_id, $meeting_id)
...
try {
    $result = $api_instance->v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstopPut($user_id, $meeting_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling RecordingApi->v1UserUserIdLiveMeetingsMeetingIdRecordingsactionstopPut: ', $e->getMessage(), PHP_EOL;
}
?>
```
