...
class MeetingApi
{
     ...
     * @param  int $numeric_meeting_id The meeting ID that participants will see and use to join the conference. When joining via phone, this is the code they enter via DTMF to join. (required)
     * @param  string $endpoint_guid The GUID of an endpoint.  Usually retrieved from the List Meeting Endpoints endpoint. (required)
     * @param  \BlueJeansMeetingsRestApi\Model\Layout $layout Specifies the video layout format. (required)
     * @param  bool $is_leader is_leader (optional)
     * @param  bool $push Push these changes to all participants.  Requires Meeting access token with moderator privileges. (optional)
     *
     * @throws \BlueJeansMeetingsRestApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateEndpointLayout($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader = null, $push = null)
    {
        $this->updateEndpointLayoutWithHttpInfo($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader, $push);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEndpointLayoutWithHttpInfo($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader = null, $push = null)
    {
        $returnType = '';
        $request = $this->updateEndpointLayoutRequest($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader, $push);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEndpointLayoutAsync($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader = null, $push = null)
    {
        return $this->updateEndpointLayoutAsyncWithHttpInfo($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader, $push)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEndpointLayoutAsyncWithHttpInfo($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader = null, $push = null)
    {
        $returnType = '';
        $request = $this->updateEndpointLayoutRequest($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader, $push);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateEndpointLayoutRequest($user_id, $numeric_meeting_id, $endpoint_guid, $layout, $is_leader = null, $push = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($layout === null || (is_array($layout) && count($layout) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $layout when calling updateEndpointLayout'
            );
        }
    ...
    {
        $this->updateMeetingEndpointWithHttpInfo($user_id, $numeric_meeting_id, $endpoint_guid, $mute_audio, $mute_video, $leave_meeting);
    }
