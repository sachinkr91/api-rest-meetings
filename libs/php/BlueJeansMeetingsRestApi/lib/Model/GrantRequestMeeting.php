 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GrantRequestMeeting implements ModelInterface, ArrayAccess
{
    ...
    const GRANT_TYPE_MEETING_PASSCODE = 'meeting_passcode';
    ...
    {
        return [
            self::GRANT_TYPE_MEETING_PASSCODE,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['meeting_numeric_id'] === null) {
            $invalidProperties[] = "'meeting_numeric_id' can't be null";
        }
        if ($this->container['meeting_passcode'] === null) {
            $invalidProperties[] = "'meeting_passcode' can't be null";
        }
