 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SetSharing implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'setSharing';
    ...
    protected static $swaggerTypes = [
        'meeting_guid' => 'string',
        'owner_id' => 'int',
        'recepient_type' => '\BlueJeansMeetingsRestApi\Model\ComponentsRecepientOptions'
    ];
    ...
    /**
     * Sets meeting_guid
     * @param string $meeting_guid The globally unique identifier (GUID) of the meeting of interest. This value is a string which contains the numeric meeting id, followed by a colon, followed by a 128-bit integer number formatted as 5 alphanumeric segments separated by dashes.
     * @return $this
     */
    ...
    /**
     * Gets recepient_type
     * @return \BlueJeansMeetingsRestApi\Model\ComponentsRecepientOptions
     */
    ...
    /**
     * Sets recepient_type
     * @param \BlueJeansMeetingsRestApi\Model\ComponentsRecepientOptions $recepient_type The ownerId field is the unique Id number of the BlueJeans account that owns the recording
     * @return $this
     */
