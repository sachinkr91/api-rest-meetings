 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecordingHistory implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getCompositeContentStatusAllowableValues();
        if (!in_array($this->container['composite_content_status'], $allowed_values)) {
    ...
    {
        $allowed_values = $this->getCompositeContentStatusAllowableValues();
        if (!is_null($composite_content_status) && !in_array($composite_content_status, $allowed_values)) {
     ...
     * @param \BlueJeansMeetingsRestApi\Model\RecordingSession[] $recording_sessions
     * @return $this
     */
