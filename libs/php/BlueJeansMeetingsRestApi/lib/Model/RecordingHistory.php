...
/**
 * RecordingHistory Class Doc Comment
 *
 * @category Class
 * @package  BlueJeansMeetingsRestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecordingHistory implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecordingHistory';
    ...
    protected static $swaggerTypes = [
        ...
        'view_count' => 'int',
        'recording_sessions' => '\BlueJeansMeetingsRestApi\Model\RecordingSession[]'
    ];
    ...
    const COMPOSITE_CONTENT_STATUS_PROCESSED = 'PROCESSED';
     ...
     * @return string[]
     */
    public function getCompositeContentStatusAllowableValues()
    {
        return [
            self::COMPOSITE_CONTENT_STATUS_PROCESSED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCompositeContentStatusAllowableValues();
        if (!is_null($this->container['composite_content_status']) && !in_array($this->container['composite_content_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'composite_content_status', must be one of '%s'",
     ...
     * Sets chapter_name
     *
     * @param string $chapter_name chapter_name
     *
     * @return $this
     */
     ...
     *
     * @param int $composite_content_id composite_content_id
     *
     * @return $this
     */
     ...
     *
     * @param string $composite_content_status composite_content_status
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCompositeContentStatusAllowableValues();
        if (!is_null($composite_content_status) && !in_array($composite_content_status, $allowedValues, true)) {
     ...
     *
     * @param int $parent_recording_id parent_recording_id
     *
     * @return $this
     */
     ...
     *
     * @return \BlueJeansMeetingsRestApi\Model\RecordingSession[]
     */
     ...
     *
     * @param \BlueJeansMeetingsRestApi\Model\RecordingSession[] $recording_sessions recording_sessions
     *
     * @return $this
     */
