 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FilterHighLowTs implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getComparisonAllowableValues();
        if (!in_array($this->container['comparison'], $allowed_values)) {
            $invalid_properties[] = sprintf(
    ...
    {
        $allowed_values = $this->getComparisonAllowableValues();
        if (!is_null($comparison) && !in_array($comparison, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'comparison', must be one of '%s'",
                    implode("', '", $allowed_values)
