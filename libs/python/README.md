...
```sh
pip install git+https://github.com/bluejeans/api-rest-onvideo.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/bluejeans/api-rest-onvideo.git`)
