...
class HistoryApi(object):
    ...
    def v1_enterprise_enterprise_id_meeting_history_meeting_guid_get(self, enterprise_id, meeting_guid, **kwargs):
        """
        List Meetings
        This endpoint retrieves a list of meetings.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_enterprise_enterprise_id_meeting_history_meeting_guid_get(enterprise_id, meeting_guid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.v1_enterprise_enterprise_id_meeting_history_meeting_guid_get_with_http_info(enterprise_id, meeting_guid, **kwargs)
        else:
            (data) = self.v1_enterprise_enterprise_id_meeting_history_meeting_guid_get_with_http_info(enterprise_id, meeting_guid, **kwargs)
            return data

    def v1_enterprise_enterprise_id_meeting_history_meeting_guid_get_with_http_info(self, enterprise_id, meeting_guid, **kwargs):
        """
        List Meetings
        This endpoint retrieves a list of meetings.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_enterprise_enterprise_id_meeting_history_meeting_guid_get_with_http_info(enterprise_id, meeting_guid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_enterprise_enterprise_id_meeting_history_meeting_guid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'enterprise_id' is set
        if ('enterprise_id' not in params) or (params['enterprise_id'] is None):
            raise ValueError("Missing the required parameter `enterprise_id` when calling `v1_enterprise_enterprise_id_meeting_history_meeting_guid_get`")
        # verify the required parameter 'meeting_guid' is set
        if ('meeting_guid' not in params) or (params['meeting_guid'] is None):
            raise ValueError("Missing the required parameter `meeting_guid` when calling `v1_enterprise_enterprise_id_meeting_history_meeting_guid_get`")
    ...
    def v1_user_user_id_meeting_history_meeting_guid_get(self, user_id, meeting_guid, **kwargs):
        """
        List Meetings
        This endpoint retrieves a list of meetings.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_user_user_id_meeting_history_meeting_guid_get(user_id, meeting_guid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.v1_user_user_id_meeting_history_meeting_guid_get_with_http_info(user_id, meeting_guid, **kwargs)
        else:
            (data) = self.v1_user_user_id_meeting_history_meeting_guid_get_with_http_info(user_id, meeting_guid, **kwargs)
            return data

    def v1_user_user_id_meeting_history_meeting_guid_get_with_http_info(self, user_id, meeting_guid, **kwargs):
        """
        List Meetings
        This endpoint retrieves a list of meetings.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_user_user_id_meeting_history_meeting_guid_get_with_http_info(user_id, meeting_guid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_user_user_id_meeting_history_meeting_guid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `v1_user_user_id_meeting_history_meeting_guid_get`")
        # verify the required parameter 'meeting_guid' is set
        if ('meeting_guid' not in params) or (params['meeting_guid'] is None):
            raise ValueError("Missing the required parameter `meeting_guid` when calling `v1_user_user_id_meeting_history_meeting_guid_get`")
