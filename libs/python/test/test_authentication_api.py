...
from BlueJeansOnVideoRestApi.apis.authentication_api import AuthenticationApi
...
class TestAuthenticationApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = BlueJeansOnVideoRestApi.apis.authentication_api.AuthenticationApi()
