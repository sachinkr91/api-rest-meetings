...
from BlueJeansMeetingsRestApi.apis.authentication_api import AuthenticationApi
...
class TestAuthenticationApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = BlueJeansMeetingsRestApi.apis.authentication_api.AuthenticationApi()
