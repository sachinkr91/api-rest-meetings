...
class MeetingApi(object):
    ...
    def cancel_meeting(self, user_id, meeting_id, email, cancellation_message, **kwargs):
        """
        Cancel Meeting
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cancel_meeting(user_id, meeting_id, email, cancellation_message, callback=callback_function)
        ...
        :param str cancellation_message: Message sent to participants when meeting is deleted and email is selected (required)
        :return: None
        ...
        if kwargs.get('callback'):
            return self.cancel_meeting_with_http_info(user_id, meeting_id, email, cancellation_message, **kwargs)
        else:
            (data) = self.cancel_meeting_with_http_info(user_id, meeting_id, email, cancellation_message, **kwargs)
            return data

    def cancel_meeting_with_http_info(self, user_id, meeting_id, email, cancellation_message, **kwargs):
        """
        Cancel Meeting
        This endpoint deletes a scheuled meeting.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.cancel_meeting_with_http_info(user_id, meeting_id, email, cancellation_message, callback=callback_function)
        ...
        all_params = ['user_id', 'meeting_id', 'email', 'cancellation_message']
        ...
        if ('email' not in params) or (params['email'] is None):
            raise ValueError("Missing the required parameter `email` when calling `cancel_meeting`")
        # verify the required parameter 'cancellation_message' is set
        if ('cancellation_message' not in params) or (params['cancellation_message'] is None):
            raise ValueError("Missing the required parameter `cancellation_message` when calling `cancel_meeting`")
        ...
        if 'cancellation_message' in params:
            path_params['cancellationMessage'] = params['cancellation_message']
    ...
    def create_meeting(self, user_id, meeting, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int user_id: The ID of the user of interest. This value is an integer which can be retrieved for the current user via the Get User Account Details endpoint. (required)
        :param ScheduleMeetingMin meeting: The desired configuration for the meeting. (<b>NOTE</b> The model provided here is a <i>typical</i> minimum set of meeting parameters.) (required)
