...
class ApplicationApi(object):
    ...
    def list_client_applications(self, user_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_client_applications(user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_client_applications_with_http_info(user_id, **kwargs)
        else:
            (data) = self.list_client_applications_with_http_info(user_id, **kwargs)
            return data

    def list_client_applications_with_http_info(self, user_id, **kwargs):
        """
        List Client Applications
        This endpoint lists all the client applications associated with the access_token.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_client_applications_with_http_info(user_id, callback=callback_function)
        ...
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `list_client_applications`")
        ...
        return self.api_client.call_api('/v1/user/{user_id}/developer_applications', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
