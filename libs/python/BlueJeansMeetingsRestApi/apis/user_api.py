...
class UserApi(object):
    ...
    def change_user_tags(self, user_id, action, tag, **kwargs):
        """
        Set User Tags
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.change_user_tags(user_id, action, tag, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.change_user_tags_with_http_info(user_id, action, tag, **kwargs)
        else:
            (data) = self.change_user_tags_with_http_info(user_id, action, tag, **kwargs)
            return data

    def change_user_tags_with_http_info(self, user_id, action, tag, **kwargs):
        """
        Set User Tags
        This endpoint modifies the list of tags associated with the specified user. <b>NOTE</b> Adding a tag that is not defined in the user's Enterprise returns a 200 (success) status code.  It is recommended you validate the returned list of tags.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.change_user_tags_with_http_info(user_id, action, tag, callback=callback_function)
        ...
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `change_user_tags`")
        # verify the required parameter 'action' is set
        if ('action' not in params) or (params['action'] is None):
            raise ValueError("Missing the required parameter `action` when calling `change_user_tags`")
        # verify the required parameter 'tag' is set
        if ('tag' not in params) or (params['tag'] is None):
            raise ValueError("Missing the required parameter `tag` when calling `change_user_tags`")
        ...
        return self.api_client.call_api('/v1/user/{userId}/tags', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ComponentstagList',
    ...
    def create_room(self, user_id, room, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_room(user_id, room, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_room_with_http_info(user_id, room, **kwargs)
        else:
            (data) = self.create_room_with_http_info(user_id, room, **kwargs)
            return data

    def create_room_with_http_info(self, user_id, room, **kwargs):
        """
        Create User’s Default Meeting Settings
        This endpoint creates the user’s default meeting settings.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_room_with_http_info(user_id, room, callback=callback_function)
        ...
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `create_room`")
        # verify the required parameter 'room' is set
        if ('room' not in params) or (params['room'] is None):
            raise ValueError("Missing the required parameter `room` when calling `create_room`")
        ...
        return self.api_client.call_api('/v1/user/{user_id}/room', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_personal_meeting(self, user_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_personal_meeting(user_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_personal_meeting_with_http_info(user_id, **kwargs)
        else:
            (data) = self.get_personal_meeting_with_http_info(user_id, **kwargs)
            return data

    def get_personal_meeting_with_http_info(self, user_id, **kwargs):
        """
        Get Personal Meeting
        This endpoint gets the settings for a user's personal meeting.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_personal_meeting_with_http_info(user_id, callback=callback_function)
        ...
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `get_personal_meeting`")
        ...
        return self.api_client.call_api('/v1/user/{user_id}/personal_meeting', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PersonalMeetingRoom',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_user_tags_with_http_info(self, user_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/user/{userId}/tags', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_peresonal_meeting(self, user_id, personal_meeting, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_peresonal_meeting(user_id, personal_meeting, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_peresonal_meeting_with_http_info(user_id, personal_meeting, **kwargs)
        else:
            (data) = self.update_peresonal_meeting_with_http_info(user_id, personal_meeting, **kwargs)
            return data

    def update_peresonal_meeting_with_http_info(self, user_id, personal_meeting, **kwargs):
        """
        Update Personal Meeting
        This endpoint changes the settings for a user's personal meeting.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_peresonal_meeting_with_http_info(user_id, personal_meeting, callback=callback_function)
        ...
        all_params = ['user_id', 'personal_meeting']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params) or (params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `update_peresonal_meeting`")
        # verify the required parameter 'personal_meeting' is set
        if ('personal_meeting' not in params) or (params['personal_meeting'] is None):
            raise ValueError("Missing the required parameter `personal_meeting` when calling `update_peresonal_meeting`")
        ...
        return self.api_client.call_api('/v1/user/{user_id}/personal_meeting', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
