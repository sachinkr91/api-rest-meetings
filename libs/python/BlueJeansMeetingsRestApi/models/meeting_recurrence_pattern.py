...
class MeetingRecurrencePattern(object):
    ...
    def __init__(self, recurrence_type=None, end_date=None, recurrence_count=None, frequency=None, days_of_week_mask=None, day_of_month=None, week_of_month='NONE', month_of_year='NONE'):
        """
        MeetingRecurrencePattern - a model defined in Swagger
        """
    ...
    def recurrence_type(self):
        """
        Gets the recurrence_type of this MeetingRecurrencePattern.

        :return: The recurrence_type of this MeetingRecurrencePattern.
        :rtype: str
        """
    ...
    def recurrence_type(self, recurrence_type):
        ...
        :param recurrence_type: The recurrence_type of this MeetingRecurrencePattern.
        :type: str
        """
    ...
    def end_date(self):
        """
        Gets the end_date of this MeetingRecurrencePattern.
        This is the epoch-based ending-time (in milliseconds) for the recurrence chain of meetings.

        :return: The end_date of this MeetingRecurrencePattern.
        :rtype: int
        """
    ...
    def end_date(self, end_date):
        ...
        :param end_date: The end_date of this MeetingRecurrencePattern.
        :type: int
        """
    ...
    def recurrence_count(self):
        """
        Gets the recurrence_count of this MeetingRecurrencePattern.
        The number of reoccurring meetings

        :return: The recurrence_count of this MeetingRecurrencePattern.
        :rtype: int
        """
    ...
    def recurrence_count(self, recurrence_count):
        ...
        :param recurrence_count: The recurrence_count of this MeetingRecurrencePattern.
        :type: int
        """
    ...
    def frequency(self):
        """
        Gets the frequency of this MeetingRecurrencePattern.
        the interval of reoccurring meetings.

        :return: The frequency of this MeetingRecurrencePattern.
        :rtype: int
        """
    ...
    def frequency(self, frequency):
        ...
        :param frequency: The frequency of this MeetingRecurrencePattern.
        :type: int
        """
    ...
    def days_of_week_mask(self):
        """
        Gets the days_of_week_mask of this MeetingRecurrencePattern.
        ...
        :return: The days_of_week_mask of this MeetingRecurrencePattern.
        :rtype: int
        """
    ...
    def days_of_week_mask(self, days_of_week_mask):
        ...
        :param days_of_week_mask: The days_of_week_mask of this MeetingRecurrencePattern.
        :type: int
        """
    ...
    def day_of_month(self):
        """
        Gets the day_of_month of this MeetingRecurrencePattern.
        the numerical day in the month for monthly reoccurring meetings.

        :return: The day_of_month of this MeetingRecurrencePattern.
        :rtype: int
        """
    ...
    def day_of_month(self, day_of_month):
        ...
        :param day_of_month: The day_of_month of this MeetingRecurrencePattern.
        :type: int
        """
    ...
    def week_of_month(self):
        """
        Gets the week_of_month of this MeetingRecurrencePattern.
        the numerical week in the month for reoccuring meetings.

        :return: The week_of_month of this MeetingRecurrencePattern.
        :rtype: str
        """
    ...
    def week_of_month(self, week_of_month):
        ...
        :param week_of_month: The week_of_month of this MeetingRecurrencePattern.
        :type: str
        """
        allowed_values = ["NONE", "FIRST", "SECOND", "THIRD", "FOURTH", "LAST"]
        if week_of_month not in allowed_values:
            raise ValueError(
                "Invalid value for `week_of_month` ({0}), must be one of {1}"
    ...
    def month_of_year(self):
        """
        Gets the month_of_year of this MeetingRecurrencePattern.
        the month in the year for reoccurring meetings.

        :return: The month_of_year of this MeetingRecurrencePattern.
        :rtype: str
        """
    ...
    def month_of_year(self, month_of_year):
        ...
        :param month_of_year: The month_of_year of this MeetingRecurrencePattern.
        :type: str
        """
        allowed_values = ["NONE", "JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"]
        if month_of_year not in allowed_values:
            raise ValueError(
                "Invalid value for `month_of_year` ({0}), must be one of {1}"
