...
class ScheduleMeetingMinComp(object):
    ...
    def __init__(self, title='My Test Meeting', description=None, start=None, end=None, timezone='America/New_York', end_point_type='WEB_APP', end_point_version='2.10', attendees=None, is_large_meeting=None, is_personal_meeting=False):
        """
        ScheduleMeetingMinComp - a model defined in Swagger
        """
    ...
    def title(self):
        """
        Gets the title of this ScheduleMeetingMinComp.

        :return: The title of this ScheduleMeetingMinComp.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        ...
        :param title: The title of this ScheduleMeetingMinComp.
        :type: str
        """
        if title is None:
    ...
    def description(self):
        """
        Gets the description of this ScheduleMeetingMinComp.

        :return: The description of this ScheduleMeetingMinComp.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this ScheduleMeetingMinComp.
        :type: str
        """
    ...
    def start(self):
        """
        Gets the start of this ScheduleMeetingMinComp.
        A [UNIX Timestamp](https://currentmillis.com/) in milliseconds

        :return: The start of this ScheduleMeetingMinComp.
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        ...
        :param start: The start of this ScheduleMeetingMinComp.
        :type: int
        """
        if start is None:
    ...
    def end(self):
        """
        Gets the end of this ScheduleMeetingMinComp.
        A [UNIX Timestamp](https://currentmillis.com/) in milliseconds

        :return: The end of this ScheduleMeetingMinComp.
        :rtype: int
        """
        return self._end
    ...
    def end(self, end):
        ...
        :param end: The end of this ScheduleMeetingMinComp.
        :type: int
        """
        if end is None:
    ...
    def timezone(self):
        """
        Gets the timezone of this ScheduleMeetingMinComp.

        :return: The timezone of this ScheduleMeetingMinComp.
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        ...
        :param timezone: The timezone of this ScheduleMeetingMinComp.
        :type: str
        """
        if timezone is None:
    ...
    def end_point_type(self):
        """
        Gets the end_point_type of this ScheduleMeetingMinComp.

        :return: The end_point_type of this ScheduleMeetingMinComp.
        :rtype: str
        """
    ...
    def end_point_type(self, end_point_type):
        ...
        :param end_point_type: The end_point_type of this ScheduleMeetingMinComp.
        :type: str
        """
    ...
    def end_point_version(self):
        """
        Gets the end_point_version of this ScheduleMeetingMinComp.

        :return: The end_point_version of this ScheduleMeetingMinComp.
        :rtype: str
        """
    ...
    def end_point_version(self, end_point_version):
        ...
        :param end_point_version: The end_point_version of this ScheduleMeetingMinComp.
        :type: str
        """
    ...
    def attendees(self):
        """
        Gets the attendees of this ScheduleMeetingMinComp.

        :return: The attendees of this ScheduleMeetingMinComp.
        :rtype: list[Attendee]
        """
    ...
    def attendees(self, attendees):
        ...
        :param attendees: The attendees of this ScheduleMeetingMinComp.
        :type: list[Attendee]
        """
    ...
    def is_large_meeting(self):
        """
        Gets the is_large_meeting of this ScheduleMeetingMinComp.
        If true, the meeting is assumed to be large and thus no announcement will be made when a participant joins.

        :return: The is_large_meeting of this ScheduleMeetingMinComp.
        :rtype: bool
        """
    ...
    def is_large_meeting(self, is_large_meeting):
        ...
        :param is_large_meeting: The is_large_meeting of this ScheduleMeetingMinComp.
        :type: bool
        """
    ...
    def is_personal_meeting(self):
        """
        Gets the is_personal_meeting of this ScheduleMeetingMinComp.
        Use the scheduler's personal meeting room and Id for this meeting.

        :return: The is_personal_meeting of this ScheduleMeetingMinComp.
        :rtype: bool
        """
    ...
    def is_personal_meeting(self, is_personal_meeting):
        ...
        :param is_personal_meeting: The is_personal_meeting of this ScheduleMeetingMinComp.
        :type: bool
        """
