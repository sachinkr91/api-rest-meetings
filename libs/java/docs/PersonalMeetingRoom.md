...
**start** | **Integer** | This is the epoch-based starting time (in milliseconds) of the personal meeting. |  [optional]
**end** | **Integer** | This is the epoch-based ending time (in milliseconds) of the personal meeting. |  [optional]
...
**created** | **Integer** | This is the date and time (in milliseconds) when the meeting was created. |  [optional]
**lastModified** | **Integer** | This is the date and time (in milliseconds) when the meeting was last changed. |  [optional]
