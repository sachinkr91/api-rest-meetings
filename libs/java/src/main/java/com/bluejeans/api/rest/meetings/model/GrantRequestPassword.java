...
public class GrantRequestPassword {
  ...
  public GrantRequestPassword grantType(GrantTypeEnum grantType) {
  ...
  **/
   ...
   * @return username
  **/
  @ApiModelProperty(required = true, value = "Your user name that you use to login to our site.")
   ...
   * @return password
  **/
  @ApiModelProperty(required = true, value = "Your user password that you use to login to our site.")
