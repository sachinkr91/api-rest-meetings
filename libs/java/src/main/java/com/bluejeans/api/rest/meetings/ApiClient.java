...
import com.bluejeans.api.rest.meetings.auth.Authentication;
import com.bluejeans.api.rest.meetings.auth.HttpBasicAuth;
import com.bluejeans.api.rest.meetings.auth.ApiKeyAuth;
import com.bluejeans.api.rest.meetings.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.bluejeans.com";
    ...
    public ApiClient() {
        ...
        authentications.put("access_token", new ApiKeyAuth("query", "access_token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bluejeans.com
