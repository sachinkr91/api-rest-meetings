...
public class GrantRequestCode {
  ...
  private GrantTypeEnum grantType = GrantTypeEnum.CODE;
   ...
   * @return grantType
  **/
  @ApiModelProperty(required = true, value = "The type of access token you are requesting. Use \"authorization_code\".")
  ...
  **/
   ...
   * @return redirectUri
  **/
  @ApiModelProperty(required = true, value = "One of the registered url or sub-url of registered urls.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Code obtained after /oauth2/authorize redirect.")
