...
public class GrantRequestRevoke {
   ...
   * @return clientId
  **/
  @ApiModelProperty(example = "null", required = true, value = "The client ID will be generated on creation of the application. Normally, a 32 character hexadecimal numeric string.")
