...
public class PayloadPairingCodePstn   {
   ...
   * @return endpointName
  **/
  @ApiModelProperty(example = "null", value = "Typically, the first and last name of the user.")
  ...
  **/
   ...
   * @return capabilities
  **/
  @ApiModelProperty(example = "null", value = "Send a single element set to AUDIO at this time.")
