...
import com.bluejeans.api.rest.meetings.model.AnalyticsFeedbackCommentsComments;
...
public class AnalyticsFeedbackComments {
  ...
  private List<AnalyticsFeedbackCommentsComments> comments = null;
  ...
  public AnalyticsFeedbackComments addCommentsItem(AnalyticsFeedbackCommentsComments commentsItem) {
    if (this.comments == null) {
      this.comments = new ArrayList<AnalyticsFeedbackCommentsComments>();
    }
