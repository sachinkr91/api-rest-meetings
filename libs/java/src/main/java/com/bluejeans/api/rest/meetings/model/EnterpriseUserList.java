...
import com.bluejeans.api.rest.meetings.model.EnterpriseUserListUsers;
 ...
 */
@ApiModel(description = "This Model has been deprecated (6/25/2018)")
...
public class EnterpriseUserList {
  ...
  private List<EnterpriseUserListUsers> users = null;
   ...
   * @return count
  **/
  @ApiModelProperty(value = "The number of users in the result.")
  ...
  public EnterpriseUserList addUsersItem(EnterpriseUserListUsers usersItem) {
    if (this.users == null) {
      this.users = new ArrayList<EnterpriseUserListUsers>();
    }
