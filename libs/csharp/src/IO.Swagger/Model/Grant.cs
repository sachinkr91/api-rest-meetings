...
namespace IO.Swagger.Model
{
    ...
    public partial class Grant :  IEquatable<Grant>
    {
        ...
        /// <param name="ExpiresIn">Timestamp.</param>
        /// <param name="RefreshToken">RefreshToken.</param>
        /// <param name="Scope">Scope.</param>
        public Grant(string AccessToken = null, int? ExpiresIn = null, string RefreshToken = null, Scope Scope = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Grant);
        }
