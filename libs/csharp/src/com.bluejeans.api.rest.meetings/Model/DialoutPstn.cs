...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DialoutPstn :  IEquatable<DialoutPstn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DialoutPstn" /> class.
        /// </summary>
        /// <param name="connectionGuid">connectionGuid.</param>
        /// <param name="endpointGuid">endpointGuid.</param>
        public DialoutPstn(string connectionGuid = default(string), string endpointGuid = default(string))
        {
        ...
        {
            return this.Equals(input as DialoutPstn);
        }

        /// <summary>
        /// Returns true if DialoutPstn instances are equal
        /// </summary>
        /// <param name="input">Instance of DialoutPstn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DialoutPstn input)
        {
            if (input == null)
                return false;
