...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class EndpointsInnerConnections :  IEquatable<EndpointsInnerConnections>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EndpointsInnerConnections);
        }

        /// <summary>
        /// Returns true if EndpointsInnerConnections instances are equal
        /// </summary>
        /// <param name="input">Instance of EndpointsInnerConnections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndpointsInnerConnections input)
        {
            if (input == null)
                return false;
