...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class AnalyticsRoiDataRoiRanges :  IEquatable<AnalyticsRoiDataRoiRanges>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AnalyticsRoiDataRoiRanges);
        }

        /// <summary>
        /// Returns true if AnalyticsRoiDataRoiRanges instances are equal
        /// </summary>
        /// <param name="other">Instance of AnalyticsRoiDataRoiRanges to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsRoiDataRoiRanges other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.DistanceRange.Equals(other.DistanceRange)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DistanceRange != null)
                    hash = hash * 59 + this.DistanceRange.GetHashCode();
                return hash;
            }
        }
