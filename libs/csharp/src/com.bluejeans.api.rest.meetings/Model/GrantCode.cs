...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantCode :  IEquatable<GrantCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantCode" /> class.
        /// </summary>
        ...
        public GrantCode(string accessToken = default(string), string refreshToken = default(string), int? expiresIn = default(int?), GrantCodeScope scope = default(GrantCodeScope))
        {
        ...
        {
            return this.Equals(input as GrantCode);
        }

        /// <summary>
        /// Returns true if GrantCode instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantCode input)
        {
            if (input == null)
                return false;
