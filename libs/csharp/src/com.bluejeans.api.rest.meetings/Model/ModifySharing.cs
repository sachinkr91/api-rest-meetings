...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class ModifySharing :  IEquatable<ModifySharing>, IValidatableObject
    {
        ...
        public ModifySharing(bool? Downloadable = default(bool?), ComponentsrecepientOptions RecepientType = default(ComponentsrecepientOptions))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModifySharing);
        }

        /// <summary>
        /// Returns true if ModifySharing instances are equal
        /// </summary>
        /// <param name="other">Instance of ModifySharing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifySharing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
