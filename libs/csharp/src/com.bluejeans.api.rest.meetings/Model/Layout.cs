...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class Layout :  IEquatable<Layout>, IValidatableObject
    {
        ...
        public enum SubLayoutModeEnum
        {
            ...
            /// <summary>
            /// Enum VideoContiniousPresence for value: VideoContiniousPresence
            /// </summary>
            [EnumMember(Value = "VideoContiniousPresence")]
            VideoContiniousPresence = 1
        }
        ...
        public bool Equals(Layout input)
        {
            ...
            return 
                ...
                (
                    this.SubLayoutMode == input.SubLayoutMode ||
                    (this.SubLayoutMode != null &&
                    this.SubLayoutMode.Equals(input.SubLayoutMode))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubLayoutMode != null)
                    hashCode = hashCode * 59 + this.SubLayoutMode.GetHashCode();
                return hashCode;
            }
        }
