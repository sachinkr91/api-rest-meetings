...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRefreshScope :  IEquatable<GrantRefreshScope>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GrantRefreshScope);
        }

        /// <summary>
        /// Returns true if GrantRefreshScope instances are equal
        /// </summary>
        /// <param name="other">Instance of GrantRefreshScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRefreshScope other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
