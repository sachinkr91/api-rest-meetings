...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantRefreshScope :  IEquatable<GrantRefreshScope>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantRefreshScope" /> class.
        /// </summary>
        ...
        public GrantRefreshScope(int? user = default(int?), List<GrantCodeScopeAppPermissions> appPermissions = default(List<GrantCodeScopeAppPermissions>), string partitionName = default(string), Partition partition = default(Partition), string bearerPermissions = default(string))
        {
            this.User = user;
        ...
        {
            return this.Equals(input as GrantRefreshScope);
        }

        /// <summary>
        /// Returns true if GrantRefreshScope instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantRefreshScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRefreshScope input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AppPermissions == input.AppPermissions ||
                    this.AppPermissions != null &&
                    this.AppPermissions.SequenceEqual(input.AppPermissions)
                ) && 
                (
                ...
                (
                    this.BearerPermissions == input.BearerPermissions ||
                    (this.BearerPermissions != null &&
                    this.BearerPermissions.Equals(input.BearerPermissions))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AppPermissions != null)
                    hashCode = hashCode * 59 + this.AppPermissions.GetHashCode();
                ...
                if (this.BearerPermissions != null)
                    hashCode = hashCode * 59 + this.BearerPermissions.GetHashCode();
                return hashCode;
            }
        }
