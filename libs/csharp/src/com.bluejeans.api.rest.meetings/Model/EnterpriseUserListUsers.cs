...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnterpriseUserListUsers :  IEquatable<EnterpriseUserListUsers>, IValidatableObject
    {
        /// <summary>
        ...
        public EnterpriseUserListUsers(int? id = default(int?), string uri = default(string))
        {
            this.Id = id;
            this.Uri = uri;
        }
        ...
        {
            return this.Equals(input as EnterpriseUserListUsers);
        }

        /// <summary>
        /// Returns true if EnterpriseUserListUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseUserListUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseUserListUsers input)
        {
            if (input == null)
                return false;
