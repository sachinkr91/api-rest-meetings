...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class CountryEndpoint :  IEquatable<CountryEndpoint>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CountryEndpoint);
        }

        /// <summary>
        /// Returns true if CountryEndpoint instances are equal
        /// </summary>
        /// <param name="other">Instance of CountryEndpoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountryEndpoint other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.EndpointCount.Equals(other.EndpointCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EndpointCount != null)
                    hash = hash * 59 + this.EndpointCount.GetHashCode();
