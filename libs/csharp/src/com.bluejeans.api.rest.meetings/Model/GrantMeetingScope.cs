...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantMeetingScope :  IEquatable<GrantMeetingScope>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GrantMeetingScope);
        }

        /// <summary>
        /// Returns true if GrantMeetingScope instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantMeetingScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantMeetingScope input)
        {
            if (input == null)
                return false;
