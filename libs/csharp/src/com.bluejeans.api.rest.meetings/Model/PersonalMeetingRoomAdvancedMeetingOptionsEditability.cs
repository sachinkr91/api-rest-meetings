...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class PersonalMeetingRoomAdvancedMeetingOptionsEditability :  IEquatable<PersonalMeetingRoomAdvancedMeetingOptionsEditability>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="AutoRecord">null.</param>
        /// <param name="EnforceMeetingEncryption">null.</param>
        /// <param name="VideoBestFit">null.</param>
        /// <param name="EnforceMeetingEncryptionAllowPSTN">null.</param>
        /// <param name="DisallowChat">null.</param>
        /// <param name="MuteParticipantsOnEntry">null.</param>
        /// <param name="ModeratorLess">null.</param>
        /// <param name="ShowAllAttendeesInMeetingInvite">null.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PersonalMeetingRoomAdvancedMeetingOptionsEditability);
        }

        /// <summary>
        /// Returns true if PersonalMeetingRoomAdvancedMeetingOptionsEditability instances are equal
        /// </summary>
        /// <param name="other">Instance of PersonalMeetingRoomAdvancedMeetingOptionsEditability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalMeetingRoomAdvancedMeetingOptionsEditability other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
