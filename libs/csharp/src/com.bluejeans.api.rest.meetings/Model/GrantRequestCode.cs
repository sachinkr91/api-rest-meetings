...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestCode :  IEquatable<GrantRequestCode>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="grantType">The type of access token you are requesting. Use \&quot;authorization_code\&quot;. (default to GrantTypeEnum.Authorizationcode).</param>
        ...
        /// <param name="redirectUri">One of the registered url or sub-url of registered urls..</param>
        /// <param name="code">Code obtained after /oauth2/authorize redirect..</param>
        public GrantRequestCode(GrantTypeEnum? grantType = GrantTypeEnum.Authorizationcode, string clientId = default(string), string clientSecret = default(string), string redirectUri = default(string), string code = default(string))
        {
            ...
            if (grantType == null)
            {
                this.GrantType = GrantTypeEnum.Authorizationcode;
            }
            else
            {
