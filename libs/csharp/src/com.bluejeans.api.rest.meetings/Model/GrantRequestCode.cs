...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestCode :  IEquatable<GrantRequestCode>, IValidatableObject
    {
        ...
        public enum GrantTypeEnum
        {
            ...
            /// <summary>
            /// Enum Code for "authorization_code"
            /// </summary>
        ...
        /// Initializes a new instance of the <see cref="GrantRequestCode" /> class.
        /// </summary>
        /// <param name="GrantType">The type of access token you are requesting. Use \&quot;authorization_code\&quot;. (required) (default to GrantTypeEnum.Code).</param>
        ...
        public GrantRequestCode(GrantTypeEnum? GrantType = GrantTypeEnum.Code, string ClientId = default(string), string ClientSecret = default(string), string RedirectUri = default(string), string Code = default(string))
        {
