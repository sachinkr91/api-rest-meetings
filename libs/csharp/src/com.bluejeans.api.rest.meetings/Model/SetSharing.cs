...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetSharing :  IEquatable<SetSharing>, IValidatableObject
    {
        /// <summary>
        ...
        public SetSharing(string MeetingGuid = default(string), int? OwnerId = default(int?), ComponentsrecepientOptions RecepientType = default(ComponentsrecepientOptions))
        {
        ...
        /// </summary>
        /// <value>The globally unique identifier (GUID) of the meeting of interest. This value is a string which contains the numeric meeting id, followed by a colon, followed by a 128-bit integer number formatted as 5 alphanumeric segments separated by dashes.</value>
        ...
        public ComponentsrecepientOptions RecepientType { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SetSharing);
        }

        /// <summary>
        /// Returns true if SetSharing instances are equal
        /// </summary>
        /// <param name="other">Instance of SetSharing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetSharing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
