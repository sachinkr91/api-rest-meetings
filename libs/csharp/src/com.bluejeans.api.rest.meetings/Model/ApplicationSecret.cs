...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class ApplicationSecret :  IEquatable<ApplicationSecret>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApplicationSecret);
        }

        /// <summary>
        /// Returns true if ApplicationSecret instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationSecret to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationSecret input)
        {
            if (input == null)
                return false;
