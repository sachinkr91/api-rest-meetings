...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class PayloadPairingCodePstn :  IEquatable<PayloadPairingCodePstn>, IValidatableObject
    {
        ...
        public PayloadPairingCodePstn(string EndpointName = default(string), EndpointTypeEnum? EndpointType = default(EndpointTypeEnum?), int? UserId = default(int?), LanguageCodeEnum? LanguageCode = default(LanguageCodeEnum?), List<string> Capabilities = default(List<string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PayloadPairingCodePstn);
        }

        /// <summary>
        /// Returns true if PayloadPairingCodePstn instances are equal
        /// </summary>
        /// <param name="other">Instance of PayloadPairingCodePstn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayloadPairingCodePstn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
