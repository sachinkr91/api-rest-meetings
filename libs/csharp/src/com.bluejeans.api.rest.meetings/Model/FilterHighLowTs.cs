...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class FilterHighLowTs :  IEquatable<FilterHighLowTs>, IValidatableObject
    {
        ...
        public enum ValueEnum
        {
            ...
            /// <summary>
            /// Enum Lowts for "lowts"
            /// </summary>
            [EnumMember(Value = "lowts")]
            Lowts,
            
            /// <summary>
            /// Enum Hights for "hights"
            /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FilterHighLowTs);
        }

        /// <summary>
        /// Returns true if FilterHighLowTs instances are equal
        /// </summary>
        /// <param name="other">Instance of FilterHighLowTs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterHighLowTs other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
