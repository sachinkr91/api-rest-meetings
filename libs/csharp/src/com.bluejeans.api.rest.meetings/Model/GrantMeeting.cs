...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantMeeting :  IEquatable<GrantMeeting>, IValidatableObject
    {
        /// <summary>
        ...
        public GrantMeetingScope Scope { get; set; }
        ...
        {
            return this.Equals(input as GrantMeeting);
        }

        /// <summary>
        /// Returns true if GrantMeeting instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantMeeting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantMeeting input)
        {
            if (input == null)
                return false;
