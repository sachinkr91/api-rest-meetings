...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class MeetingExtendedIndigo :  IEquatable<MeetingExtendedIndigo>, IValidatableObject
    {
        ...
        public MeetingExtendedIndigo(string MeetingId = default(string), string MeetingUUID = default(string), string UserName = default(string), string Email = default(string), int? EncryptionType = default(int?), string Title = default(string), string UserFullName = default(string), string PhoneNumber = default(string), string UserFeatures = default(string), ScheduledFromEnum? ScheduledFrom = default(ScheduledFromEnum?), int? InviteeCount = default(int?), bool? Personal = default(bool?), bool? MuteOnEntry = default(bool?), bool? AutoRecord = default(bool?), string EnterpriseName = default(string), bool? ModeratorLess = default(bool?), long? StartTime = default(long?), long? EndTime = default(long?), int? TotalCallSeconds = default(int?), long? CreateTime = default(long?), int? EndpointsCount = default(int?), int? ConcurrentEndpoints = default(int?), int? LiveVisibleEndpointsCount = default(int?), int? QualarooRating = default(int?), int? QualarooCount = default(int?), bool? MeetingRecording = default(bool?), bool? VideoShare = default(bool?), bool? ContentShare = default(bool?), bool? LiveRecording = default(bool?), bool? LiveVideoShare = default(bool?), bool? LiveContentShare = default(bool?), bool? LargeMeeting = default(bool?), float? RoiDistance = default(float?), bool? Mpls = default(bool?), string Id = default(string), List<EndpointIndigo> Endpoints = default(List<EndpointIndigo>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MeetingExtendedIndigo);
        }

        /// <summary>
        /// Returns true if MeetingExtendedIndigo instances are equal
        /// </summary>
        /// <param name="other">Instance of MeetingExtendedIndigo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeetingExtendedIndigo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
