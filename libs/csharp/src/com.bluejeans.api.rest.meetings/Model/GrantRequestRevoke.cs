...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestRevoke :  IEquatable<GrantRequestRevoke>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GrantRequestRevoke);
        }

        /// <summary>
        /// Returns true if GrantRequestRevoke instances are equal
        /// </summary>
        /// <param name="other">Instance of GrantRequestRevoke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRequestRevoke other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
