...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantRequestRevoke :  IEquatable<GrantRequestRevoke>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantRequestRevoke" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GrantRequestRevoke() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantRequestRevoke" /> class.
        /// </summary>
        ...
        public GrantRequestRevoke(string clientId = default(string), string clientSecret = default(string))
        {
            // to ensure "clientId" is required (not null)
            if (clientId == null)
            {
                throw new InvalidDataException("clientId is a required property for GrantRequestRevoke and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("clientSecret is a required property for GrantRequestRevoke and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GrantRequestRevoke {\n");
        ...
        {
            return this.Equals(input as GrantRequestRevoke);
        }

        /// <summary>
        /// Returns true if GrantRequestRevoke instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantRequestRevoke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRequestRevoke input)
        {
            if (input == null)
                return false;
