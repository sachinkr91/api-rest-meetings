...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class ContentContentPropertiesLevels :  IEquatable<ContentContentPropertiesLevels>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ContentContentPropertiesLevels);
        }

        /// <summary>
        /// Returns true if ContentContentPropertiesLevels instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentContentPropertiesLevels to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentContentPropertiesLevels input)
        {
            if (input == null)
                return false;
