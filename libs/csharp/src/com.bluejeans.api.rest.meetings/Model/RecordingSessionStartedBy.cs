...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class RecordingSessionStartedBy :  IEquatable<RecordingSessionStartedBy>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingSessionStartedBy);
        }

        /// <summary>
        /// Returns true if RecordingSessionStartedBy instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingSessionStartedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingSessionStartedBy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
