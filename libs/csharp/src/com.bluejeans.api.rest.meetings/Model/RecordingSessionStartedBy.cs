...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingSessionStartedBy :  IEquatable<RecordingSessionStartedBy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordingSessionStartedBy" /> class.
        /// </summary>
        /// <param name="endpointName">endpointName.</param>
        /// <param name="endpointGuid">endpointGuid.</param>
        public RecordingSessionStartedBy(string endpointName = default(string), string endpointGuid = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordingSessionStartedBy {\n");
        ...
        {
            return this.Equals(input as RecordingSessionStartedBy);
        }

        /// <summary>
        /// Returns true if RecordingSessionStartedBy instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordingSessionStartedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingSessionStartedBy input)
        {
            if (input == null)
                return false;
