...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class PersonalMeetingRoomAdvancedMeetingOptions :  IEquatable<PersonalMeetingRoomAdvancedMeetingOptions>, IValidatableObject
    {
        ...
        /// <param name="AllowStream">null.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PersonalMeetingRoomAdvancedMeetingOptions);
        }

        /// <summary>
        /// Returns true if PersonalMeetingRoomAdvancedMeetingOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of PersonalMeetingRoomAdvancedMeetingOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalMeetingRoomAdvancedMeetingOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AllowStream == other.AllowStream ||
                    this.AllowStream != null &&
                    this.AllowStream.Equals(other.AllowStream)
                ) && 
                (
                ...
                (
                    this.Editability == other.Editability ||
                    this.Editability != null &&
                    this.Editability.Equals(other.Editability)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowStream != null)
                    hash = hash * 59 + this.AllowStream.GetHashCode();
                ...
                if (this.Editability != null)
                    hash = hash * 59 + this.Editability.GetHashCode();
                return hash;
            }
        }
