...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestRefresh :  IEquatable<GrantRequestRefresh>, IValidatableObject
    {
        ...
        protected GrantRequestRefresh() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantRequestRefresh" /> class.
        /// </summary>
        /// <param name="GrantType">The type of access token you are requesting. (required) (default to GrantTypeEnum.Token).</param>
        ...
        public GrantRequestRefresh(GrantTypeEnum? GrantType = GrantTypeEnum.Token, string ClientId = default(string), string ClientSecret = default(string), string RefreshToken = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GrantRequestRefresh);
        }

        /// <summary>
        /// Returns true if GrantRequestRefresh instances are equal
        /// </summary>
        /// <param name="other">Instance of GrantRequestRefresh to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRequestRefresh other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
