...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class MeetingDeprecatedAdvancedMeetingOptions :  IEquatable<MeetingDeprecatedAdvancedMeetingOptions>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MeetingDeprecatedAdvancedMeetingOptions);
        }

        /// <summary>
        /// Returns true if MeetingDeprecatedAdvancedMeetingOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of MeetingDeprecatedAdvancedMeetingOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeetingDeprecatedAdvancedMeetingOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
