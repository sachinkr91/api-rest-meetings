...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class FilterObject :  IEquatable<FilterObject>, IValidatableObject
    {
        ...
        public enum FieldEnum
        {
            ...
            /// <summary>
            /// Enum StartTime for "startTime"
            /// </summary>
            [EnumMember(Value = "startTime")]
            StartTime,
            
            /// <summary>
            /// Enum EndTime for "endTime"
            /// </summary>
            [EnumMember(Value = "endTime")]
            EndTime,
            
            /// <summary>
            /// Enum MeetingUUID for "meetingUUID"
            /// </summary>
            ...
            /// <summary>
            /// Enum EnterpriseId for "enterpriseId"
            /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FilterObject);
        }

        /// <summary>
        /// Returns true if FilterObject instances are equal
        /// </summary>
        /// <param name="other">Instance of FilterObject to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Comparison != null)
                    hash = hash * 59 + this.Comparison.GetHashCode();
                return hash;
            }
        }
