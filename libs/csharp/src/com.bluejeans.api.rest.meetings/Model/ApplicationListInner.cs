...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class ApplicationListInner :  IEquatable<ApplicationListInner>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApplicationListInner);
        }

        /// <summary>
        /// Returns true if ApplicationListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationListInner input)
        {
            if (input == null)
                return false;
