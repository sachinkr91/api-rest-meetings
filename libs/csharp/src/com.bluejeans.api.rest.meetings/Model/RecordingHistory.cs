...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingHistory :  IEquatable<RecordingHistory>, IValidatableObject
    {
        /// <summary>
        /// Defines CompositeContentStatus
        /// </summary>
        ...
        public CompositeContentStatusEnum? CompositeContentStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordingHistory" /> class.
        /// </summary>
        ...
        public RecordingHistory(string chapterId = default(string), int? id = default(int?), int? startTimeOffset = default(int?), int? endTimeOffset = default(int?), string chapterName = default(string), int? totalSize = default(int?), int? compositeContentId = default(int?), CompositeContentStatusEnum? compositeContentStatus = default(CompositeContentStatusEnum?), int? parentRecordingId = default(int?), int? viewCount = default(int?), List<RecordingSession> recordingSessions = default(List<RecordingSession>))
        {
        ...
        {
            return this.Equals(input as RecordingHistory);
        }

        /// <summary>
        /// Returns true if RecordingHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordingHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingHistory input)
        {
            if (input == null)
                return false;
