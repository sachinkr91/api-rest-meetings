...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestClient :  IEquatable<GrantRequestClient>, IValidatableObject
    {
        ...
        public enum GrantTypeEnum
        {
            ...
            /// <summary>
            /// Enum Credentials for "client_credentials"
            /// </summary>
        ...
        /// Initializes a new instance of the <see cref="GrantRequestClient" /> class.
        /// </summary>
        /// <param name="GrantType">The type of access token you are requesting. (required) (default to GrantTypeEnum.Credentials).</param>
        ...
        public GrantRequestClient(GrantTypeEnum? GrantType = GrantTypeEnum.Credentials, string ClientId = default(string), string ClientSecret = default(string))
        {
