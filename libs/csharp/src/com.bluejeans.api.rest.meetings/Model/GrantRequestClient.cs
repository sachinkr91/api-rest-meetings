...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestClient :  IEquatable<GrantRequestClient>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="grantType">The type of access token you are requesting. (default to GrantTypeEnum.Clientcredentials).</param>
        /// <param name="clientId">The value given within the BlueJeans Enterprise Administration console..</param>
        /// <param name="clientSecret">The value given within the BlueJeans Enterprise Administration console..</param>
        public GrantRequestClient(GrantTypeEnum? grantType = GrantTypeEnum.Clientcredentials, string clientId = default(string), string clientSecret = default(string))
        {
            ...
            if (grantType == null)
            {
                this.GrantType = GrantTypeEnum.Clientcredentials;
            }
            else
            {
