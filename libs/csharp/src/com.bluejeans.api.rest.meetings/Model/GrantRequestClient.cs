...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestClient :  IEquatable<GrantRequestClient>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GrantRequestClient);
        }

        /// <summary>
        /// Returns true if GrantRequestClient instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantRequestClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantRequestClient input)
        {
            if (input == null)
                return false;
