...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class PairingCodeWebRTC :  IEquatable<PairingCodeWebRTC>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PairingCodeWebRTC);
        }

        /// <summary>
        /// Returns true if PairingCodeWebRTC instances are equal
        /// </summary>
        /// <param name="input">Instance of PairingCodeWebRTC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PairingCodeWebRTC input)
        {
            if (input == null)
                return false;
