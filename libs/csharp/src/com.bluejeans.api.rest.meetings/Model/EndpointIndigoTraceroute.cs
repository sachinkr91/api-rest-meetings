...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class EndpointIndigoTraceroute :  IEquatable<EndpointIndigoTraceroute>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EndpointIndigoTraceroute);
        }

        /// <summary>
        /// Returns true if EndpointIndigoTraceroute instances are equal
        /// </summary>
        /// <param name="input">Instance of EndpointIndigoTraceroute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndpointIndigoTraceroute input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.TracePath != null &&
                    this.TracePath.SequenceEqual(input.TracePath)
                );
        }
