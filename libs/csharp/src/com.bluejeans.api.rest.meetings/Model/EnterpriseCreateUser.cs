...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class EnterpriseCreateUser :  IEquatable<EnterpriseCreateUser>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnterpriseCreateUser);
        }

        /// <summary>
        /// Returns true if EnterpriseCreateUser instances are equal
        /// </summary>
        /// <param name="other">Instance of EnterpriseCreateUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseCreateUser other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
