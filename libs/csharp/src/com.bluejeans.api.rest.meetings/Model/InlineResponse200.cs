...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="User">The ID of the user who this token corresponds to..</param>
        public InlineResponse200(int? User = default(int?))
        {
            this.User = User;
        }
        ...
        /// </summary>
        /// <value>The ID of the user who this token corresponds to.</value>
