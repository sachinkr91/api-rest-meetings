...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class GrantRequestMeeting :  IEquatable<GrantRequestMeeting>, IValidatableObject
    {
        ...
        public enum GrantTypeEnum
        {
            ...
            /// <summary>
            /// Enum Passcode for "meeting_passcode"
            /// </summary>
        ...
        /// Initializes a new instance of the <see cref="GrantRequestMeeting" /> class.
        /// </summary>
        /// <param name="GrantType">The type of access token you are requesting. (required) (default to GrantTypeEnum.Passcode).</param>
        /// <param name="MeetingNumericId">Meeting ID (required).</param>
        /// <param name="MeetingPasscode">Pin (required).</param>
        public GrantRequestMeeting(GrantTypeEnum? GrantType = GrantTypeEnum.Passcode, string MeetingNumericId = default(string), string MeetingPasscode = default(string))
        {
