...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class EndpointLocationSummary :  IEquatable<EndpointLocationSummary>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EndpointLocationSummary);
        }

        /// <summary>
        /// Returns true if EndpointLocationSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of EndpointLocationSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndpointLocationSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.CountriesCount == other.CountriesCount ||
                    this.CountriesCount != null &&
                    this.CountriesCount.SequenceEqual(other.CountriesCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CountriesCount != null)
                    hash = hash * 59 + this.CountriesCount.GetHashCode();
