...
namespace com.bluejeans.api.rest.meetings.Model
{
    ...
    public partial class MeetingSharing :  IEquatable<MeetingSharing>, IValidatableObject
    {
        ...
        public MeetingSharing(int? Id = default(int?), string MeetingGuid = default(string), int? OwnerId = default(int?), string SharingUrl = default(string), ComponentsrecepientOptions RecepientType = default(ComponentsrecepientOptions), MeetingSharingProperties Properties = default(MeetingSharingProperties), StatusEnum? Status = default(StatusEnum?), bool? Downloadable = default(bool?), string Passcode = default(string), string Validity = default(string), int? Created = default(int?), int? Lastmodified = default(int?))
        {
            this.Id = Id;
