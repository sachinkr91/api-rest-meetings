...
namespace com.bluejeans.api.rest.meetings.Api
{
    ...
    public interface IUserApi : IApiAccessor
    {
        ...
        ApiResponse<ComponentstagList> ChangeUserTagsWithHttpInfo (int? userId, string action, string tag);
        /// <summary>
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>ApiResponse of ComponentstagList</returns>
        ApiResponse<ComponentstagList> GetUserTagsWithHttpInfo (int? userId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ComponentstagList> ChangeUserTagsAsync (int? userId, string action, string tag);
        ...
        System.Threading.Tasks.Task<ApiResponse<ComponentstagList>> ChangeUserTagsAsyncWithHttpInfo (int? userId, string action, string tag);
        /// <summary>
        /// Create User’s Default Meeting Settings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>Task of ComponentstagList</returns>
        System.Threading.Tasks.Task<ComponentstagList> GetUserTagsAsync (int? userId);
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>Task of ApiResponse (ComponentstagList)</returns>
        System.Threading.Tasks.Task<ApiResponse<ComponentstagList>> GetUserTagsAsyncWithHttpInfo (int? userId);
        /// <summary>
        /// Remoke Granted Application
        /// </summary>
        /// <remarks>
    ...
    public partial class UserApi : IUserApi
    {
        ...
        /// <param name="tag">The name of tag</param>
        /// <returns>ComponentstagList</returns>
        public ComponentstagList ChangeUserTags (int? userId, string action, string tag)
        {
             ApiResponse<ComponentstagList> localVarResponse = ChangeUserTagsWithHttpInfo(userId, action, tag);
        ...
        /// <param name="tag">The name of tag</param>
        /// <returns>ApiResponse of ComponentstagList</returns>
        public ApiResponse< ComponentstagList > ChangeUserTagsWithHttpInfo (int? userId, string action, string tag)
        {
        ...
        /// <param name="tag">The name of tag</param>
        /// <returns>Task of ComponentstagList</returns>
        public async System.Threading.Tasks.Task<ComponentstagList> ChangeUserTagsAsync (int? userId, string action, string tag)
        {
             ApiResponse<ComponentstagList> localVarResponse = await ChangeUserTagsAsyncWithHttpInfo(userId, action, tag);
             return localVarResponse.Data;
        ...
        /// <param name="tag">The name of tag</param>
        /// <returns>Task of ApiResponse (ComponentstagList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComponentstagList>> ChangeUserTagsAsyncWithHttpInfo (int? userId, string action, string tag)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UserApi->ChangeUserTags");
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>ComponentstagList</returns>
        public ComponentstagList GetUserTags (int? userId)
        {
             ApiResponse<ComponentstagList> localVarResponse = GetUserTagsWithHttpInfo(userId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>ApiResponse of ComponentstagList</returns>
        public ApiResponse< ComponentstagList > GetUserTagsWithHttpInfo (int? userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>Task of ComponentstagList</returns>
        public async System.Threading.Tasks.Task<ComponentstagList> GetUserTagsAsync (int? userId)
        {
             ApiResponse<ComponentstagList> localVarResponse = await GetUserTagsAsyncWithHttpInfo(userId);
             return localVarResponse.Data;
        ...
        /// <param name="userId">The user ID for the account to retrieve tags.  This value is an integer which can be retrieved for the current user via the Get Enterprise Profile endpoint.</param>
        /// <returns>Task of ApiResponse (ComponentstagList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComponentstagList>> GetUserTagsAsyncWithHttpInfo (int? userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UserApi->GetUserTags");
