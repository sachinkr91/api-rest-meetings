...
namespace com.bluejeans.api.rest.meetings.Api
{
    ...
    public interface IRecordingApi : IApiAccessor
    {
        ...
        /// <returns>ComponentsrecordingMoved</returns>
        ...
        /// <param name="originalOwner">The ID of the recording&#39;s current owner.</param>
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>ApiResponse of ComponentsrecordingMoved</returns>
        ApiResponse<ComponentsrecordingMoved> MoveRecordingOwnerWithHttpInfo (int? userId, int? originalOwner, int? newOwner);
        /// <summary>
        /// Start Recording
        /// </summary>
        /// <remarks>
        ...
        /// <param name="originalOwner">The ID of the recording&#39;s current owner.</param>
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>Task of ComponentsrecordingMoved</returns>
        System.Threading.Tasks.Task<ComponentsrecordingMoved> MoveRecordingOwnerAsync (int? userId, int? originalOwner, int? newOwner);
        ...
        /// <param name="originalOwner">The ID of the recording&#39;s current owner.</param>
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>Task of ApiResponse (ComponentsrecordingMoved)</returns>
        System.Threading.Tasks.Task<ApiResponse<ComponentsrecordingMoved>> MoveRecordingOwnerAsyncWithHttpInfo (int? userId, int? originalOwner, int? newOwner);
        /// <summary>
        /// Start Recording
        /// </summary>
        /// <remarks>
    ...
    public partial class RecordingApi : IRecordingApi
    {
        ...
        public ApiResponse< MeetingSharing > CreateShareRecordingsWithHttpInfo (int? userId, string meetingGuid, SetSharing setSharing)
        {
            ...
            if (meetingGuid != null) localVarPathParams.Add("meetingGuid", Configuration.ApiClient.ParameterToString(meetingGuid)); // path parameter
            if (setSharing != null && setSharing.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(setSharing); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<MeetingSharing>(localVarStatusCode,
                ...
                (MeetingSharing) Configuration.ApiClient.Deserialize(localVarResponse, typeof(MeetingSharing)));
        }
        ...
        public ApiResponse< MeetingSharing > ModifyShareRecordingsWithHttpInfo (int? userId, string meetingGuid, string sharingId, ModifySharing modifySharing)
        {
            ...
            {
                localVarPostBody = Configuration.ApiClient.Serialize(modifySharing); // http body (model) parameter
            }
            else
            {
        ...
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>ComponentsrecordingMoved</returns>
        public ComponentsrecordingMoved MoveRecordingOwner (int? userId, int? originalOwner, int? newOwner)
        {
             ApiResponse<ComponentsrecordingMoved> localVarResponse = MoveRecordingOwnerWithHttpInfo(userId, originalOwner, newOwner);
             return localVarResponse.Data;
        }
        ...
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>ApiResponse of ComponentsrecordingMoved</returns>
        public ApiResponse< ComponentsrecordingMoved > MoveRecordingOwnerWithHttpInfo (int? userId, int? originalOwner, int? newOwner)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            ...
            if (userId != null) localVarPathParams.Add("user_id", Configuration.ApiClient.ParameterToString(userId)); // path parameter
            if (originalOwner != null) localVarPathParams.Add("originalOwner", Configuration.ApiClient.ParameterToString(originalOwner)); // path parameter
            if (newOwner != null) localVarPathParams.Add("newOwner", Configuration.ApiClient.ParameterToString(newOwner)); // path parameter
            ...
            return new ApiResponse<ComponentsrecordingMoved>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ComponentsrecordingMoved) Configuration.ApiClient.Deserialize(localVarResponse, typeof(ComponentsrecordingMoved)));
        }
        ...
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>Task of ComponentsrecordingMoved</returns>
        public async System.Threading.Tasks.Task<ComponentsrecordingMoved> MoveRecordingOwnerAsync (int? userId, int? originalOwner, int? newOwner)
        {
             ApiResponse<ComponentsrecordingMoved> localVarResponse = await MoveRecordingOwnerAsyncWithHttpInfo(userId, originalOwner, newOwner);
             return localVarResponse.Data;
        ...
        /// <param name="newOwner">The ID of the intended owner for the recording.</param>
        /// <returns>Task of ApiResponse (ComponentsrecordingMoved)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ComponentsrecordingMoved>> MoveRecordingOwnerAsyncWithHttpInfo (int? userId, int? originalOwner, int? newOwner)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling RecordingApi->MoveRecordingOwner");
