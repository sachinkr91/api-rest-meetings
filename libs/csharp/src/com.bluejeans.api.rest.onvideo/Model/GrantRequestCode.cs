...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantRequestCode :  IEquatable<GrantRequestCode>
    {
        /// <summary>
        ...
        public GrantRequestCode(string GrantType = null, string ClientId = null, string ClientSecret = null, string RedirectUri = null, string Code = null)
        {
