...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantCodeScope :  IEquatable<GrantCodeScope>
    {
        /// <summary>
        ...
        public GrantCodeScope(int? User = null, List<GrantCodeScopeAppPermissions> AppPermissions = null, string PartitionName = null, Partition Partition = null, string BearerPermissions = null, string ClientId = null)
        {
            this.User = User;
