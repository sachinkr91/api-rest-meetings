...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordingStartedBy :  IEquatable<RecordingStartedBy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordingStartedBy" /> class.
        /// </summary>
        /// <param name="EndpointName">EndpointName.</param>
        /// <param name="EndpointGuid">EndpointGuid.</param>
        public RecordingStartedBy(string EndpointName = default(string), string EndpointGuid = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingStartedBy);
        }

        /// <summary>
        /// Returns true if RecordingStartedBy instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingStartedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingStartedBy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
