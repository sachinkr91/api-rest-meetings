...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Endpoints : List<EndpointsInner>,  IEquatable<Endpoints>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Endpoints);
        }

        /// <summary>
        /// Returns true if Endpoints instances are equal
        /// </summary>
        /// <param name="other">Instance of Endpoints to be compared</param>
        /// <returns>Boolean</returns>
