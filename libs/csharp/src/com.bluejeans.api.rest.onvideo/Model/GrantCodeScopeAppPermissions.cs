...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    public partial class GrantCodeScopeAppPermissions :  IEquatable<GrantCodeScopeAppPermissions>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GrantCodeScopeAppPermissions);
        }

        /// <summary>
        /// Returns true if GrantCodeScopeAppPermissions instances are equal
        /// </summary>
        /// <param name="other">Instance of GrantCodeScopeAppPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantCodeScopeAppPermissions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AllowedRegex == other.AllowedRegex ||
                    this.AllowedRegex != null &&
                    this.AllowedRegex.Equals(other.AllowedRegex)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowedRegex != null)
                    hash = hash * 59 + this.AllowedRegex.GetHashCode();
                return hash;
            }
        }
