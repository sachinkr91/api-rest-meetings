...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    public partial class AnalyticsRoiData :  IEquatable<AnalyticsRoiData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AnalyticsRoiData);
        }

        /// <summary>
        /// Returns true if AnalyticsRoiData instances are equal
        /// </summary>
        /// <param name="other">Instance of AnalyticsRoiData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsRoiData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.RoiRanges == other.RoiRanges ||
                    this.RoiRanges != null &&
                    this.RoiRanges.SequenceEqual(other.RoiRanges)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RoiRanges != null)
                    hash = hash * 59 + this.RoiRanges.GetHashCode();
                return hash;
            }
        }
