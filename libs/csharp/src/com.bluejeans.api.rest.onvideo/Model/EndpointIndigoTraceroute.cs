...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EndpointIndigoTraceroute :  IEquatable<EndpointIndigoTraceroute>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndpointIndigoTraceroute" /> class.
        /// </summary>
        /// <param name="TracePath">TracePath.</param>
        public EndpointIndigoTraceroute(List<EndpointIndigoTracerouteTracePath> TracePath = null)
        {
