...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PairingCodeWebRTC :  IEquatable<PairingCodeWebRTC>
    {
        /// <summary>
        ...
        public PairingCodeWebRTC(string Callguid = null, string EndpointGuid = null, bool? ForceTURN = null, string PairingCode = null, int? Status = null, StatusTextEnum? StatusText = null, List<PairingCodeSIPTurnservers> Turnservers = null, string Uri = null, string SeamEndpointGuid = null, string ConnectionGuid = null, string EndpointName = null)
        {
