...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    public partial class AnalyticsFeedbackComments :  IEquatable<AnalyticsFeedbackComments>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AnalyticsFeedbackComments);
        }

        /// <summary>
        /// Returns true if AnalyticsFeedbackComments instances are equal
        /// </summary>
        /// <param name="other">Instance of AnalyticsFeedbackComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsFeedbackComments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
