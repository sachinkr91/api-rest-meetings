...
namespace com.bluejeans.api.rest.onvideo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantCode :  IEquatable<GrantCode>
    {
        /// <summary>
        ...
        public GrantCode(string AccessToken = null, string RefreshToken = null, int? ExpiresIn = null, GrantCodeScope Scope = null)
        {
