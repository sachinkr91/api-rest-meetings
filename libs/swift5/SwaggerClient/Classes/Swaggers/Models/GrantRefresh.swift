...
public struct GrantRefresh: Codable {
    ...
    public var scope: GrantRefreshScope?

    public init(accessToken: String?, refreshToken: String?, expiresIn: Int?, scope: GrantRefreshScope?) {
