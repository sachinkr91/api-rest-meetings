...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.ApplicationApi();
  });
  ...
  describe('ApplicationApi', function() {
    ...
    describe('listClientApplications', function() {
      it('should call listClientApplications successfully', function(done) {
        //uncomment below and update the code to test listClientApplications
        //instance.listClientApplications(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
