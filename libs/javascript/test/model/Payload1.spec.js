...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansOnVideoRestApi.Payload1();
  });
  ...
  describe('Payload1', function() {
    it('should create an instance of Payload1', function() {
      // uncomment below and update the code to test Payload1
      //var instane = new BlueJeansOnVideoRestApi.Payload1();
      //expect(instance).to.be.a(BlueJeansOnVideoRestApi.Payload1);
    });
