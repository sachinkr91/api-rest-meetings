...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansOnVideoRestApi.RecordingInner();
  });
  ...
  describe('RecordingInner', function() {
    it('should create an instance of RecordingInner', function() {
      // uncomment below and update the code to test RecordingInner
      //var instane = new BlueJeansOnVideoRestApi.RecordingInner();
      //expect(instance).to.be.a(BlueJeansOnVideoRestApi.RecordingInner);
    });
