...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansOnVideoRestApi.GrantCode();
  });
  ...
  describe('GrantCode', function() {
    it('should create an instance of GrantCode', function() {
      ...
      //var instane = new BlueJeansOnVideoRestApi.GrantCode();
      //expect(instance).to.be.a(BlueJeansOnVideoRestApi.GrantCode);
    });
