...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.ScheduleMeetingMinComp();
  });
  ...
  describe('ScheduleMeetingMinComp', function() {
    it('should create an instance of ScheduleMeetingMinComp', function() {
      // uncomment below and update the code to test ScheduleMeetingMinComp
      //var instance = new BlueJeansMeetingsRestApi.ScheduleMeetingMinComp();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.ScheduleMeetingMinComp);
    });
