...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansOnVideoRestApi.RecordingStartedBy();
  });
  ...
  describe('RecordingStartedBy', function() {
    it('should create an instance of RecordingStartedBy', function() {
      // uncomment below and update the code to test RecordingStartedBy
      //var instane = new BlueJeansOnVideoRestApi.RecordingStartedBy();
      //expect(instance).to.be.a(BlueJeansOnVideoRestApi.RecordingStartedBy);
    });
