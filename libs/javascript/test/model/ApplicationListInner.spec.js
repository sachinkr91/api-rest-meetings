...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.ApplicationListInner();
  });
  ...
  describe('ApplicationListInner', function() {
    it('should create an instance of ApplicationListInner', function() {
      // uncomment below and update the code to test ApplicationListInner
      //var instane = new BlueJeansMeetingsRestApi.ApplicationListInner();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.ApplicationListInner);
    });
