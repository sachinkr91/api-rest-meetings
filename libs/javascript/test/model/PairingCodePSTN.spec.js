...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueJeansMeetingsRestApi.PairingCodePSTN();
  });
  ...
  describe('PairingCodePSTN', function() {
    it('should create an instance of PairingCodePSTN', function() {
      // uncomment below and update the code to test PairingCodePSTN
      //var instance = new BlueJeansMeetingsRestApi.PairingCodePSTN();
      //expect(instance).to.be.a(BlueJeansMeetingsRestApi.PairingCodePSTN);
    });
