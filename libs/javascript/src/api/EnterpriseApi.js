...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComponentstagList', 'model/EnterpriseCreateUser', 'model/EnterpriseUserSearch', 'model/Error', 'model/UserId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ComponentstagList'), require('../model/EnterpriseCreateUser'), require('../model/EnterpriseUserSearch'), require('../model/Error'), require('../model/UserId'));
  } else {
    // Browser globals (root is window)
    if (!root.BlueJeansMeetingsRestApi) {
      root.BlueJeansMeetingsRestApi = {};
    }
    root.BlueJeansMeetingsRestApi.EnterpriseApi = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.ComponentstagList, root.BlueJeansMeetingsRestApi.EnterpriseCreateUser, root.BlueJeansMeetingsRestApi.EnterpriseUserSearch, root.BlueJeansMeetingsRestApi.Error, root.BlueJeansMeetingsRestApi.UserId);
  }
}(this, function(ApiClient, ComponentstagList, EnterpriseCreateUser, EnterpriseUserSearch, Error, UserId) {
  'use strict';
