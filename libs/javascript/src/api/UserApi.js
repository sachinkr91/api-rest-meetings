...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComponentstagList', 'model/Enterprise', 'model/Error', 'model/GrantedApplications', 'model/PersonalMeetingRoom', 'model/Room', 'model/User'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ComponentstagList'), require('../model/Enterprise'), require('../model/Error'), require('../model/GrantedApplications'), require('../model/PersonalMeetingRoom'), require('../model/Room'), require('../model/User'));
  } else {
    // Browser globals (root is window)
    if (!root.BlueJeansMeetingsRestApi) {
      root.BlueJeansMeetingsRestApi = {};
    }
    root.BlueJeansMeetingsRestApi.UserApi = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.ComponentstagList, root.BlueJeansMeetingsRestApi.Enterprise, root.BlueJeansMeetingsRestApi.Error, root.BlueJeansMeetingsRestApi.GrantedApplications, root.BlueJeansMeetingsRestApi.PersonalMeetingRoom, root.BlueJeansMeetingsRestApi.Room, root.BlueJeansMeetingsRestApi.User);
  }
}(this, function(ApiClient, ComponentstagList, Enterprise, Error, GrantedApplications, PersonalMeetingRoom, Room, User) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ComponentstagList} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ComponentstagList}
     */
    this.changeUserTags = function(userId, action, tag, callback) {
      ...
      var returnType = ComponentstagList;
