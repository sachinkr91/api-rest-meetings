...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComponentsrecordingMoved', 'model/Content', 'model/Error', 'model/Meeting', 'model/MeetingSharing', 'model/ModifySharing', 'model/RecordingHistoryList', 'model/SetSharing'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ComponentsrecordingMoved'), require('../model/Content'), require('../model/Error'), require('../model/Meeting'), require('../model/MeetingSharing'), require('../model/ModifySharing'), require('../model/RecordingHistoryList'), require('../model/SetSharing'));
  } else {
    // Browser globals (root is window)
    if (!root.BlueJeansMeetingsRestApi) {
      root.BlueJeansMeetingsRestApi = {};
    }
    root.BlueJeansMeetingsRestApi.RecordingApi = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.ComponentsrecordingMoved, root.BlueJeansMeetingsRestApi.Content, root.BlueJeansMeetingsRestApi.Error, root.BlueJeansMeetingsRestApi.Meeting, root.BlueJeansMeetingsRestApi.MeetingSharing, root.BlueJeansMeetingsRestApi.ModifySharing, root.BlueJeansMeetingsRestApi.RecordingHistoryList, root.BlueJeansMeetingsRestApi.SetSharing);
  }
}(this, function(ApiClient, ComponentsrecordingMoved, Content, Error, Meeting, MeetingSharing, ModifySharing, RecordingHistoryList, SetSharing) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ComponentsrecordingMoved} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ComponentsrecordingMoved}
     */
    this.moveRecordingOwner = function(userId, originalOwner, newOwner, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ComponentsrecordingMoved;
