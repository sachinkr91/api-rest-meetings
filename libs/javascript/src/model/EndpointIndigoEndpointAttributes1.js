...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('reIceCount')) {
        obj['reIceCount'] = ApiClient.convertToType(data['reIceCount'], 'Integer');
      }
      if (data.hasOwnProperty('remoteConnectionCount')) {
        obj['remoteConnectionCount'] = ApiClient.convertToType(data['remoteConnectionCount'], 'Integer');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Integer} reIceCount
   */
  exports.prototype['reIceCount'] = undefined;
  /**
   * @member {Integer} remoteConnectionCount
   */
