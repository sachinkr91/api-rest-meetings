...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.ApplicationListInner = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The ApplicationListInner model module.
   * @module model/ApplicationListInner
   * @version 1.0.4407232018
   */

  /**
   * Constructs a new <code>ApplicationListInner</code>.
   * @alias module:model/ApplicationListInner
   * @class
   */
  ...
  /**
   * Constructs a <code>ApplicationListInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApplicationListInner} obj Optional instance to populate.
   * @return {module:model/ApplicationListInner} The populated <code>ApplicationListInner</code> instance.
   */
