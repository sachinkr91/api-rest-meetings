...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.CountriesCountRec = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The CountriesCountRec model module.
   * @module model/CountriesCountRec
   * @version 1.0.0.mm44 (7/06/2018)
   */

  /**
   * Constructs a new <code>CountriesCountRec</code>.
   * @alias module:model/CountriesCountRec
   * @class
   */
  ...
  /**
   * Constructs a <code>CountriesCountRec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CountriesCountRec} obj Optional instance to populate.
   * @return {module:model/CountriesCountRec} The populated <code>CountriesCountRec</code> instance.
   */
