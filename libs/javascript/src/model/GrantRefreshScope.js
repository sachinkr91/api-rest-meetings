...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantRefreshScope = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.GrantCodeScopeAppPermissions, root.BlueJeansMeetingsRestApi.Partition);
  }
  ...
  /**
   * The GrantRefreshScope model module.
   * @module model/GrantRefreshScope
   * @version 1.0.0.mm44 (7/06/2018)
   */

  /**
   * Constructs a new <code>GrantRefreshScope</code>.
   * @alias module:model/GrantRefreshScope
   * @class
   */
  ...
  /**
   * Constructs a <code>GrantRefreshScope</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantRefreshScope} obj Optional instance to populate.
   * @return {module:model/GrantRefreshScope} The populated <code>GrantRefreshScope</code> instance.
   */
