...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.MeetingAdvancedMeetingOptionsEditability = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The MeetingAdvancedMeetingOptionsEditability model module.
   * @module model/MeetingAdvancedMeetingOptionsEditability
   * @version 1.0.0.mm44 (7/06/2018)
   */

  /**
   * Constructs a new <code>MeetingAdvancedMeetingOptionsEditability</code>.
   * @alias module:model/MeetingAdvancedMeetingOptionsEditability
   * @class
   */
  ...
  /**
   * Constructs a <code>MeetingAdvancedMeetingOptionsEditability</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MeetingAdvancedMeetingOptionsEditability} obj Optional instance to populate.
   * @return {module:model/MeetingAdvancedMeetingOptionsEditability} The populated <code>MeetingAdvancedMeetingOptionsEditability</code> instance.
   */
