...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantRequestRefresh = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
   ...
   * @class
   * @param grantType {module:model/GrantRequestRefresh.GrantTypeEnum} The type of access token you are requesting.
   ...
   * @member {module:model/GrantRequestRefresh.GrantTypeEnum} grant_type
