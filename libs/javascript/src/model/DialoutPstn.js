...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.DialoutPstn = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The DialoutPstn model module.
   * @module model/DialoutPstn
   * @version 1.0.4407102018
   */

  /**
   * Constructs a new <code>DialoutPstn</code>.
   * @alias module:model/DialoutPstn
   * @class
   */
  ...
  /**
   * Constructs a <code>DialoutPstn</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DialoutPstn} obj Optional instance to populate.
   * @return {module:model/DialoutPstn} The populated <code>DialoutPstn</code> instance.
   */
