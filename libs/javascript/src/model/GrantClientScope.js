...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantClientScope = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.Partition);
  }
  ...
  /**
   * The GrantClientScope model module.
   * @module model/GrantClientScope
   * @version 1.0.4407102018
   */

  /**
   * Constructs a new <code>GrantClientScope</code>.
   * @alias module:model/GrantClientScope
   * @class
   */
  ...
  /**
   * Constructs a <code>GrantClientScope</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantClientScope} obj Optional instance to populate.
   * @return {module:model/GrantClientScope} The populated <code>GrantClientScope</code> instance.
   */
