...
(function(root, factory) {
  ...
  /**
   * The GrantCode model module.
   * @module model/GrantCode
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GrantCode</code>.
   * @alias module:model/GrantCode
   * @class
   */
  ...
  /**
   * Constructs a <code>GrantCode</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantCode} obj Optional instance to populate.
   * @return {module:model/GrantCode} The populated <code>GrantCode</code> instance.
   */
