...
(function(root, factory) {
  ...
  /**
   * The GrantPasswordScope model module.
   * @module model/GrantPasswordScope
   * @version 1.0.4407102018
   */

  /**
   * Constructs a new <code>GrantPasswordScope</code>.
   * @alias module:model/GrantPasswordScope
   * @class
   */
  ...
  /**
   * Constructs a <code>GrantPasswordScope</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantPasswordScope} obj Optional instance to populate.
   * @return {module:model/GrantPasswordScope} The populated <code>GrantPasswordScope</code> instance.
   */
