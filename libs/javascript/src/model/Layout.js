...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.Layout = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('layoutMode')) {
        obj['layoutMode'] = ApiClient.convertToType(data['layoutMode'], 'String');
      }
      if (data.hasOwnProperty('subLayoutMode')) {
        obj['subLayoutMode'] = ApiClient.convertToType(data['subLayoutMode'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Layout.LayoutModeEnum} layoutMode
   */
  ...
  /**
   * Allowed values for the <code>layoutMode</code> property.
   * @enum {String}
   * @readonly
   */
  exports.LayoutModeEnum = {
    /**
     * value: "Video"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>subLayoutMode</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SubLayoutModeEnum = {
    /**
     * value: "VideoContiniousPresence"
     * @const
     */
