...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansOnVideoRestApi.RecordingInner = factory(root.BlueJeansOnVideoRestApi.ApiClient);
  }
  ...
  /**
   * The RecordingInner model module.
   * @module model/RecordingInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RecordingInner</code>.
   * @alias module:model/RecordingInner
   * @class
   */
  ...
  /**
   * Constructs a <code>RecordingInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RecordingInner} obj Optional instance to populate.
   * @return {module:model/RecordingInner} The populated <code>RecordingInner</code> instance.
   */
