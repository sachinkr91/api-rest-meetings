...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ComponentsrecepientOptions', 'model/MeetingSharingProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ComponentsrecepientOptions'), require('./MeetingSharingProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.BlueJeansMeetingsRestApi) {
      root.BlueJeansMeetingsRestApi = {};
    }
    root.BlueJeansMeetingsRestApi.MeetingSharing = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.ComponentsrecepientOptions, root.BlueJeansMeetingsRestApi.MeetingSharingProperties);
  }
}(this, function(ApiClient, ComponentsrecepientOptions, MeetingSharingProperties) {
  'use strict';
