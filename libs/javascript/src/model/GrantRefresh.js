...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantRefresh = factory(root.BlueJeansMeetingsRestApi.ApiClient, root.BlueJeansMeetingsRestApi.GrantRefreshScope);
  }
  ...
  /**
   * The GrantRefresh model module.
   * @module model/GrantRefresh
   * @version 1.0.4407102018
   */

  /**
   * Constructs a new <code>GrantRefresh</code>.
   * @alias module:model/GrantRefresh
   * @class
   */
  ...
  /**
   * Constructs a <code>GrantRefresh</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantRefresh} obj Optional instance to populate.
   * @return {module:model/GrantRefresh} The populated <code>GrantRefresh</code> instance.
   */
