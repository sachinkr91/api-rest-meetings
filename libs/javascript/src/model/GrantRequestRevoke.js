...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.GrantRequestRevoke = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The GrantRequestRevoke model module.
   * @module model/GrantRequestRevoke
   * @version 1.0.4407232018
   */

  /**
   * Constructs a new <code>GrantRequestRevoke</code>.
   * @alias module:model/GrantRequestRevoke
   * @class
  ...
  /**
   * Constructs a <code>GrantRequestRevoke</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GrantRequestRevoke} obj Optional instance to populate.
   * @return {module:model/GrantRequestRevoke} The populated <code>GrantRequestRevoke</code> instance.
   */
