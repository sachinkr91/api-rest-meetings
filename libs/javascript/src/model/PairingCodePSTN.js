...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.PairingCodePSTN = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The PairingCodePSTN model module.
   * @module model/PairingCodePSTN
   * @version 1.0.0.mm44 (7/06/2018)
   */

  /**
   * Constructs a new <code>PairingCodePSTN</code>.
   * @alias module:model/PairingCodePSTN
   * @class
   */
  ...
  /**
   * Constructs a <code>PairingCodePSTN</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PairingCodePSTN} obj Optional instance to populate.
   * @return {module:model/PairingCodePSTN} The populated <code>PairingCodePSTN</code> instance.
   */
