...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BlueJeansMeetingsRestApi.AnalyticsFeedbackScores = factory(root.BlueJeansMeetingsRestApi.ApiClient);
  }
  ...
  /**
   * The AnalyticsFeedbackScores model module.
   * @module model/AnalyticsFeedbackScores
   * @version 1.0.4407232018
   */

  /**
   * Constructs a new <code>AnalyticsFeedbackScores</code>.
   * @alias module:model/AnalyticsFeedbackScores
   * @class
   */
  ...
  /**
   * Constructs a <code>AnalyticsFeedbackScores</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnalyticsFeedbackScores} obj Optional instance to populate.
   * @return {module:model/AnalyticsFeedbackScores} The populated <code>AnalyticsFeedbackScores</code> instance.
   */
